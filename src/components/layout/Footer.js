      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between items-center">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h3 className="text-2xl font-bold mb-2">RAG Solutions</h3>
            <p className="text-gray-400">Shaping the future of AI in Africa</p>
          </div>
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#demo" className="hover:text-blue-300 transition-colors duration-300">Demo</a></li>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center">
          <p>&copy; 2024 RAG Solutions. All rights reserved.</p>
        </div>
      </div>
    </motion.footer>
  );
